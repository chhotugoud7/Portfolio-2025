...
const About = () => {
  ...
  return (
    ...
    scroll-mt-20'>
        <h4 className='textce-center mb-2 text-lg font-Ovo'>Introduction</h4>
        <h2 className='text-center text-5xl font-Ovo'>About me</h2>


        <div className='flex w-full flex-col lg:flex-row items-top gap-20 my-20'>
            ...
            <div className='flex-1'>
                ...
                <button 
                    onClick={toggleText} 
                    className="text-blue-700  mt-2 hover:underline focus:outline-none"
                >
                ...
                <ul className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                    {infoList.map(({icon, iconDark, title, description}, index) => (
                        <li className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-green'
                         key={index}>
