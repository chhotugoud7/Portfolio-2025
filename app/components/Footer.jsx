            ...
            <div className="text-center">
                ...
                <div className="text-center sm:flex items-center justify-center border-t border-gray-400 mx-[10%] mt-12 py-6">
                    <ul className="flex items-center gap-10 justify-center mt-4 sm:mt-0">
                        ...
                        <li className="font-Ovo cursor-pointer transition-colors duration-300 hover:text-green-500 hover:underline  dark:hover:rounded-md  dark:hover:px-2 dark:hover:bg-white">
                            <a
                                target="_blank"
